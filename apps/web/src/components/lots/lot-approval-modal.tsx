...
export function LotApprovalModal({ isOpen, onClose, onApprove, isLoading, type }: ApprovalModalProps) {
  ...
  const title = type === 'approve' ? 'Approve Lot' : 'Reject Lot'
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder={type === 'reject' 
                ? 'Please provide a reason for rejecting this lot...' 
