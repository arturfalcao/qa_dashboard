...
import { SupplyChainStageStatus, UserRole } from '@qa-dashboard/shared'
          ...
          {supplyChainTimeline.length === 0 ? (
            ...
            <ol className="relative ml-3 border-l border-gray-200">
              {supplyChainTimeline.map((stage) => {
                ...
                return (
                  <li key={stage.id} className="mb-8 ml-4 last:mb-0">
                    <span
                      className={`absolute -left-2 top-1 h-4 w-4 rounded-full border ${meta.dot}`}
                    ></span>
