...
export class AnalyticsController {
  ...
  async getDefectRate(
    ...
    return this.analyticsService.getDefectRate(tenantId, range || 'last_7d', groupBy);
  }
  ...
  async getThroughput(
    ...
    return this.analyticsService.getThroughput(tenantId, bucket || 'day', range || 'last_7d');
  }
  ...
  async getDefectTypes(
    ...
    return this.analyticsService.getDefectTypes(tenantId, range || 'last_7d');
  }
  ...
  async getApprovalTime(
    ...
    return this.analyticsService.getApprovalTime(tenantId, range || 'last_7d');
  }
}