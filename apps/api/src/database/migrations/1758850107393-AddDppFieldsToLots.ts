...
export class AddDppFieldsToLots1758850107393 implements MigrationInterface {
    name = 'AddDppFieldsToLots1758850107393'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dpp_events" DROP CONSTRAINT "fk_dpp_events_dpp"`);
        await queryRunner.query(`ALTER TABLE "dpp_access_logs" DROP CONSTRAINT "fk_dpp_access_logs_dpp"`);
        await queryRunner.query(`ALTER TABLE "dpps" DROP CONSTRAINT "fk_dpps_creator"`);
        await queryRunner.query(`ALTER TABLE "dpps" DROP CONSTRAINT "fk_dpps_client"`);
        ...
        await queryRunner.query(`ALTER TABLE "lots" ADD "dye_lot" character varying(120)`);
        await queryRunner.query(`COMMENT ON COLUMN "lots"."dye_lot" IS 'Dye lot identifier for traceability'`);
        await queryRunner.query(`ALTER TABLE "lots" ADD "certifications" jsonb`);
        ...
        await queryRunner.query(`ALTER TABLE "lots" ADD "dpp_metadata" jsonb`);
