...
export class AddDppFieldsToLots1758850031310 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "factory_certifications" DROP CONSTRAINT IF EXISTS "FK_9731938c748101e7f4d4b1a118a"`);
        ...
        await queryRunner.query(`ALTER TABLE "factories" DROP CONSTRAINT IF EXISTS "FK_39fa445253769a08081a8b9485c"`);
        ...
        await queryRunner.query(`ALTER TABLE "photos" DROP CONSTRAINT IF EXISTS "FK_992e74d0c936c34f5e43b844259"`);
        ...
        await queryRunner.query(`ALTER TABLE "defects" DROP CONSTRAINT IF EXISTS "FK_4ce8bd137e020c3c843df2f1e2a"`);
        ...
        await queryRunner.query(`ALTER TABLE "defects" DROP CONSTRAINT IF EXISTS "FK_3dea2797377515adfee132358ba"`);
        ...
        await queryRunner.query(`ALTER TABLE "inspections" DROP CONSTRAINT IF EXISTS "FK_ae09f142a5cfb32324d3ef084d7"`);
        ...
        await queryRunner.query(`ALTER TABLE "inspections" DROP CONSTRAINT IF EXISTS "FK_be0708872a150482d84fafdf5ca"`);
        ...
        await queryRunner.query(`ALTER TABLE "approvals" DROP CONSTRAINT IF EXISTS "FK_fbeefb6072cbf5161fec58b1c36"`);
        ...
        await queryRunner.query(`ALTER TABLE "approvals" DROP CONSTRAINT IF EXISTS "FK_6424e5974a58f747eaae00e7163"`);
        ...
        await queryRunner.query(`ALTER TABLE "activities" DROP CONSTRAINT IF EXISTS "FK_b79dacbbdd92259182f873944ed"`);
        ...
        await queryRunner.query(`ALTER TABLE "reports" DROP CONSTRAINT IF EXISTS "FK_bda44e16992191ff11ad8da01e2"`);
        ...
        await queryRunner.query(`ALTER TABLE "reports" DROP CONSTRAINT IF EXISTS "FK_875b7b8cbdbc9155c34561135bf"`);
        ...
        await queryRunner.query(`ALTER TABLE "lots" DROP CONSTRAINT IF EXISTS "FK_52222ad1e6660451b31ea7e5780"`);
        ...
        await queryRunner.query(`ALTER TABLE "lots" DROP CONSTRAINT IF EXISTS "FK_8e738387523ad9133f3f5ee2617"`);
        ...
        await queryRunner.query(`ALTER TABLE "events" DROP CONSTRAINT IF EXISTS "FK_b4ea5a78d656e3c29835bf644e6"`);
        ...
        await queryRunner.query(`ALTER TABLE "events" DROP CONSTRAINT IF EXISTS "FK_8cebe14c096d6b4340d9046fe91"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT IF EXISTS "FK_0d1e90d75674c54f8660c4ed446"`);
        ...
        await queryRunner.query(`ALTER TABLE "dpp_events" DROP CONSTRAINT IF EXISTS "FK_05fbad8a3a5dafac29d6dea64b7"`);
        ...
        await queryRunner.query(`ALTER TABLE "dpp_access_logs" DROP CONSTRAINT IF EXISTS "FK_5eb01403cdb0e3b814011ea5ee5"`);
        ...
        await queryRunner.query(`ALTER TABLE "dpps" DROP CONSTRAINT IF EXISTS "FK_8b619ab36496e04c1d67bfbc643"`);
        ...
        await queryRunner.query(`ALTER TABLE "dpps" DROP CONSTRAINT IF EXISTS "FK_84cfbc26f63b938fadc8375b023"`);
